        ...
        <div className="main-container">
          ...
          <section className="section" id="projects">
            ...
            <div className="card-grid">
              ...
              <div className="card">
                ...
                <a href="https://github.com/MystCryptBust344/Autonomous-Cleaning-Robot-Arduino" target="_blank" rel="noopener noreferrer">GitHub</a>
              </div>
              <div className="card">
          ...
          <section className="section" id="contact">
            ...
            <div className="card">
              ...
              <p>GitHub: <a href="https://github.com/Adxrsh-17" target="_blank" rel="noopener noreferrer">github.com/adarshpradeep</a></p>
